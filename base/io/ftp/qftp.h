...
public:
	...
	int put(const std::vector<unsigned char>& data, const QString &file, TransferType type = Binary);
...
{
public:
	QFtpCommand(QFtp::Command cmd, QStringList raw, const std::vector<unsigned char> &ba);
